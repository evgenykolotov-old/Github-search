...
const Profile = props => {
  const {getUser, getRepos, loading, user, repos} = React.useContext(GithubContext);
        ...
        <div className="card-body">
          <div className="row">
            ...
            <div className="col">
              ...
              <a href={html_url} target="_blank" className="btn btn-dark" rel="noopener noreferrer">Открыть профиль</a>
              <ul>
